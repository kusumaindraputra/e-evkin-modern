...
exports.PuskesmasEditPermission = exports.sequelize = exports.LraRealisasi = exports.LraUploadBatch = exports.AnggaranKas = exports.SubKegiatanTarget = exports.SubKegiatanSumberAnggaran = exports.PuskesmasSubKegiatan = exports.SubKegiatan = exports.Kegiatan = exports.Satuan = exports.SumberAnggaran = exports.Laporan = exports.User = void 0;
...
const PuskesmasEditPermission_1 = __importDefault(require("./PuskesmasEditPermission"));
exports.PuskesmasEditPermission = PuskesmasEditPermission_1.default;
const LraUploadBatch_1 = __importDefault(require("./LraUploadBatch"));
exports.LraUploadBatch = LraUploadBatch_1.default;
const LraRealisasi_1 = __importDefault(require("./LraRealisasi"));
exports.LraRealisasi = LraRealisasi_1.default;
...
LraUploadBatch_1.default.hasMany(LraRealisasi_1.default, { foreignKey: 'batch_id', as: 'rows' });
LraRealisasi_1.default.belongsTo(LraUploadBatch_1.default, { foreignKey: 'batch_id', as: 'batch' });
LraUploadBatch_1.default.belongsTo(User_1.default, { foreignKey: 'uploaded_by', as: 'uploader' });
User_1.default.hasMany(LraUploadBatch_1.default, { foreignKey: 'uploaded_by', as: 'lraBatches' });
LraRealisasi_1.default.belongsTo(User_1.default, { foreignKey: 'user_id', as: 'puskesmas' });
LraRealisasi_1.default.belongsTo(SubKegiatan_1.default, { foreignKey: 'id_sub_kegiatan', as: 'subKegiatan' });
LraRealisasi_1.default.belongsTo(SumberAnggaran_1.default, { foreignKey: 'id_sumber_anggaran', as: 'sumberAnggaran' });
