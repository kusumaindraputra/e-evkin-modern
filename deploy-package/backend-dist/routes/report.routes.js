    ...
    try {
        ...
        const aggregatedData = await Laporan_1.default.findAll({
            attributes: [
                ...
                'bulan',
                'tahun',
                [database_1.default.fn('COUNT', database_1.default.col('id')), 'jumlah_laporan'],
                [database_1.default.fn('SUM', database_1.default.col('target_k')), 'total_target_k'],
                [database_1.default.fn('SUM', database_1.default.col('target_rp')), 'total_target_rp'],
                [database_1.default.fn('SUM', database_1.default.col('realisasi_k')), 'total_realisasi_k'],
                [database_1.default.fn('SUM', database_1.default.col('realisasi_rp')), 'total_realisasi_rp'],
                [database_1.default.fn('SUM', database_1.default.col('angkas')), 'total_angkas'],
            ],
            where: whereClause,
            include: [
                {
...
router.get('/by-sub-kegiatan/detail', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
        ...
        const laporan = await Laporan_1.default.findAll({
            where: {
                bulan: String(bulan),
                tahun: Number(tahun),
...
router.get('/by-sumber-anggaran/detail', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
