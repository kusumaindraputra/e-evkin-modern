...
// Create new laporan
router.post('/', auth_1.authenticate, laporan_controller_1.LaporanController.create);
// Bulk create laporan
router.post('/bulk', auth_1.authenticate, laporan_controller_1.LaporanController.bulkCreate);
// Bulk upsert laporan (optimized)
router.post('/bulk-upsert', auth_1.authenticate, laporan_controller_1.LaporanController.bulkUpsert);
// Update laporan
router.put('/:id', auth_1.authenticate, laporan_controller_1.LaporanController.update);
// Delete laporan
