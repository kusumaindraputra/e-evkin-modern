...
router.get('/kegiatan', auth_1.authenticate, async (req, res) => {
    try {
...
router.get('/kegiatan/:id', auth_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/kegiatan', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
...
router.put('/kegiatan/:id', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { id_uraian, kode, kegiatan } = req.body;
...
router.delete('/kegiatan/:id', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const kegiatan = await Kegiatan_1.default.findByPk(id);
        if (!kegiatan) {
...
router.get('/sub-kegiatan', auth_1.authenticate, async (req, res) => {
    try {
...
router.get('/sub-kegiatan/:id', auth_1.authenticate, async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/sub-kegiatan', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
...
router.put('/sub-kegiatan/:id', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const { id_kegiatan, kode_sub, kegiatan, indikator_kinerja } = req.body;
...
router.delete('/sub-kegiatan/:id', auth_1.authenticate, authorize_1.authorizeAdmin, async (req, res) => {
    try {
        const { id } = req.params;
        const subKegiatan = await SubKegiatan_1.default.findByPk(id);
        if (!subKegiatan) {
...
//# sourceMappingURL=kegiatan.routes.js.map