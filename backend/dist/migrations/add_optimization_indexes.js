...
async function up(queryInterface) {
    ...
    await addIndexIfNotExists('sub_kegiatan_target', ['user_id', 'id_sub_kegiatan', 'id_sumber_anggaran', 'tahun'], {
        name: 'idx_target_user_subkeg_sumber_tahun',
        concurrently: true,
    });
    // 4. AnggaranKas - Lookup by user + sub_kegiatan + bulan + tahun
    await addIndexIfNotExists('anggaran_kas', ['user_id', 'id_sub_kegiatan', 'bulan', 'tahun'], {
...
//# sourceMappingURL=add_optimization_indexes.js.map