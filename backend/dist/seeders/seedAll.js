...
const puskesmas_json_1 = __importDefault(require("./data/puskesmas.json"));
const laporan_json_1 = __importDefault(require("./data/laporan.json"));
const laporanData = laporan_json_1.default;
...
async function seedAll() {
    try {
        ...
        console.log(`📝 Creating ${puskesmas_json_1.default.length} puskesmas users...`);
        const puskesmasUsers = [];
        for (const puskesmas of puskesmas_json_1.default) {
